...
class ChipFlooringEnv(
    ...
    def _parse_result(self, payload: Dict) -> StepResult[ChipFlooringObservation]:
        ...
        observation = ChipFlooringObservation(
            ...
            phase=obs_data.get("phase", "placement"),
            phase_step=obs_data.get("phase_step", 0),
            instruction=obs_data.get("instruction", ""),
            hidden_constraint_count=obs_data.get("hidden_constraint_count", 0),
            revealed_constraint_count=obs_data.get("revealed_constraint_count", 0),
